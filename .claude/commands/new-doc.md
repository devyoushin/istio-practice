---
description: Istio 신규 문서를 스캐폴딩합니다. 사용법: /new-doc <카테고리> <주제>
---

아래 지침에 따라 Istio 지식 베이스 문서를 새로 작성해 주세요.

## 입력 정보
- 사용자 입력: $ARGUMENTS
- 첫 번째 인자 = 카테고리 (traffic-management, security, observability, install)
...
4. `rules/istio-conventions.md` 의 코드 작성 규칙 준수
